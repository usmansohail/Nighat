...
test = TestPositionsSet()
test.test_construction()
test.test_reduced_union_keeps_positions_sorted()
test.test_reduced_union_removes_subsumed_position()
test.test_reduced_unions_removes_duplicates()
